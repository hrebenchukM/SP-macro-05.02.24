...
bool isVowelRussian(TCHAR c) {
    return (c == _TEXT('а') || c == _TEXT('е') || c == _TEXT('ё') ||
        c == _TEXT('и') || c == _TEXT('о') || c == _TEXT('у') ||
        c == _TEXT('ы') || c == _TEXT('э') || c == _TEXT('ю') ||
        c == _TEXT('я') || c == _TEXT('А') || c == _TEXT('Е') ||
        c == _TEXT('Ё') || c == _TEXT('И') || c == _TEXT('О') ||
        c == _TEXT('У') || c == _TEXT('Ы') || c == _TEXT('Э') ||
        c == _TEXT('Ю') || c == _TEXT('Я'));
}
